export const STEMMI_SQUADRA = [
  ...
  { id: 'arpzzc', nome: 'Arpzzc', src: '/stemmi-squadra/thumbs/arpzzc.png' },
  ...
  { id: 'down', nome: 'Down', src: '/stemmi-squadra/thumbs/down.png' },
  { id: 'eagle', nome: 'Eagle', src: '/stemmi-squadra/thumbs/eagle.png' },
  { id: 'eddaii', nome: 'Eddaii', src: '/stemmi-squadra/thumbs/eddaii.png' },
  ...
  { id: 'siga', nome: 'Siga', src: '/stemmi-squadra/thumbs/siga.png' },
  { id: 'skull', nome: 'Skull', src: '/stemmi-squadra/thumbs/skull.png' },
  { id: 'slot', nome: 'Slot', src: '/stemmi-squadra/thumbs/slot.png' },
  { id: 'sushi', nome: 'Sushi', src: '/stemmi-squadra/thumbs/sushi.png' },
