...
//
//  players.attributi pesa 958 byte a giocatore: il 65% del peso di una riga.
//  Le pagine Mercato e Scambi li chiedevano per TUTTI i giocatori della lega —
//  in Serie F sono circa novecento fra rose e aste — quindi ogni apertura
//  scaricava 1,3 MB di cui 860 KB di attributi che servono solo quando si apre
//  la scheda di UNO.
//
