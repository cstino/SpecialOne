...
export function Notifiche({ userId, onApriNotifica }: NotificheProps) {
  const { notifiche, nonLette, caricamento, segnaLette } = useNotifiche(userId)
  ...
  return (
    <div className="notifiche" ref={contenitore}>
      <button
