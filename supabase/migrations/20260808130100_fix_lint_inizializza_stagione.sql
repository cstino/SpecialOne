-- ============================================================
--  FIX LINT: variabili dei loop dichiarate due volte
--
--  La riscrittura precedente (20260808130000) aveva predichiarato
--  v_leg/v_round/v_pair/v_index nel blocco declare, ma i FOR li
--  dichiarano gia' da soli — la predichiarazione era solo "ombra" inutile
--  e faceva salire i warning di lint da 2 (baseline) a 10. Tolta.
-- ============================================================
