-- I contatori dei cicli FOR sono dichiarati automaticamente da PL/pgSQL.
-- Questa sostituzione mantiene invariata la logica ed elimina gli avvisi
-- shadowed_variables/unused_variables del lint.
