...
-- ============================================================
--  SOLO IL PROPRIETARIO DEL PROGETTO PUO' CREARE NUOVE LEGHE
--
--  Richiesta esplicita dell'utente: gli altri partecipanti restano liberi
--  di entrare in una lega con un codice invito, giocare, fare mercato ecc.
--  — cambia solo chi puo' INIZIARNE una nuova. Basta il controllo qui, nella
--  funzione base: le due varianti con piu' argomenti (squadre PC, modalita'
--  draft) chiamano sempre questa prima di fare qualunque altra cosa.
-- ============================================================
