...
-- ============================================================
--  BUG: il controllo "solo l'amministratore del progetto puo' creare
--  leghe" (20260829080000_solo_admin_crea_lega.sql) confrontava
--  auth.email() con 'cristianobraccili@gmail.com' — l'email di contatto
--  dell'utente, non quella con cui accede davvero a SpecialOne. L'account
--  che ha creato Real Fampionato e LegaBot (public.leagues.admin_id)
--  risulta in auth.users con l'email cr.96bc@gmail.com: nessun account
--  reale poteva mai superare quel confronto, quindi la creazione lega
--  falliva per chiunque, proprietario incluso.
-- ============================================================
