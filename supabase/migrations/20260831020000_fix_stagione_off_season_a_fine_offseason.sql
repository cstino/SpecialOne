...
-- ============================================================
--  BUG: finalizza_offseason non risolveva mai la finestra OFF-Season
--  della stagione appena conclusa.
--
--  La finestra "OFF-Season N" viene svelata con stagione = N (la
--  stagione appena giocata, quella dei playoff appena finiti — vedi
--  avanza_finestre_scelte e admin_forza_estrazione_scelte, che alla
--  risoluzione di ON-Season N svelano subito OFF-Season con la STESSA
--  N). finalizza_offseason pero' cercava/risolveva la finestra 'off'
--  usando v_off.stagione_a (la stagione ENTRANTE, N+1), non
--  v_off.stagione_da (N): quella condizione non trovava mai nulla da
--  risolvere, quindi la chiamata a risolvi_finestra_scelte non partiva
--  mai. Scoperto il 31 agosto 2026 chiudendo manualmente l'off-season
--  di LegaBot: "OFF-Season 2" e' rimasta aperta con l'estrazione gia'
--  passata, perche' la stagione entrante (3) non aveva nessuna
--  finestra 'off' da risolvere.
--
--  Il bug esiste dalla primissima introduzione del mercato a scelte:
--  nessuna finestra OFF-Season di nessuna lega e' mai stata risolta
--  automaticamente alla chiusura dell'off-season. L'unico modo in cui
--  potevano risolversi era una chiamata manuale ad
--  admin_forza_estrazione_scelte (che non ha questo bug, perche' non
--  filtra affatto per stagione).
-- ============================================================
